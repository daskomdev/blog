    ...
    <div class="relative w-full m-0">
        ...
        <div class=" relative w-full h-auto flex flex-row">
            <div class="flex-1 pl-16 pr-32">
                <transition-group name="article-list" tag="div" class="flex flex-col">
                    <div v-for="(article) in articles" v-bind:key="article.id" class="animation-enable w-full h-120">
                        <inertia-link :href="'/artikel/' + article.slug" class=" hover:no-underline hover:text-black">
                            <div class="w-full h-full px-6 mt-2 mb-10 hover:bg-daskom-abu-muda rounded-lg p-4 ">
                                <div class=" flex flex-row">
                                    <img src="/images/test1.png" alt="" class=" rounded-lg w-1/2 h-1/2">
                                    <div class=" mt-0 ml-10 flex-col w-full">
                                        ...
                                        <div class=" font-quicksand text-xs text-justify w-full">
                                            {{article.content.length > 372 ? article.content.substring(0, 373) + "..." : article.content }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div href="" class=" w-full flex bg-daskom-abu-muda rounded-lg p-2">
            ...
            <div class="flex flex-col">
                ...
                <div class=" mx-auto mt-6">
                    <div class=" mr-24 flex flex-row text-daskom-abu-tua w-64">
                        <div class="w-1/4">
                            <a href="https://www.instagram.com/telu.daskom/" target="_blank"><svg class=" fill-current w-full h-8 mx-auto hover:text-daskom-hijau" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="26px" height="26px">
                        ...
                        <div class="w-1/4">
                            <a href="https://www.youtube.com/channel/UCgCAhA5CK3tG3pofQnn-VEA" target="_blank"><svg class=" fill-current w-full h-8 mx-auto hover:text-daskom-hijau" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="26px" height="26px">
    ...
    data() {
        return {
            articles: [{
                    ...
                    code: "SRG",
                    title: "Lorem Ipsum",
                    content: "Mauris faucibus pretium odio. Morbi eu placerat quam, at vehicula enim. Nullam eu auctor sapien. Sed et mauris imperdiet, lobortis ligula nec, convallis quam. Ut eget nunc enim. In aliquet ante risus, sed hendrerit eros porta eu. Fusce eget mauris pellentesque, condimentum eros quis, eleifend elit. Sed eu tincidunt nibh. Integer ut neque molestie massa eleifend ultrices.",
                    slug: "testt",
                    like: 100,
                    dislike: 1,
                },
